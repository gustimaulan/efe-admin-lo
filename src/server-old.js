...
async function startServer() {
  ...
  // More secure 'trust proxy' setting.
  // This trusts the X-Forwarded-For header only from localhost,
  // which is safer for development and prevents rate-limit bypass.
